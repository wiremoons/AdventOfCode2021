...
! Puzzle for Day 07 part 02 : 
! Build with:  gfortran -static-libgcc -o aoc_day07_p2 aoc_day07_p2.f90

program aoc_day07_p2

	use, intrinsic :: iso_fortran_env
	implicit none

	! Declare and set constants the AOC day and part
	integer,parameter :: day = 7, part = 2
	...
	print *, ""
	write(*,'(A,I0)') " » Part 2: Fuel used is: ",minval((/(sum((abs(crabArray-i)**2+abs(crabArray-i))/2),i=0,maxval(crabArray))/))
	print *, ""
