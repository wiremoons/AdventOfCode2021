...
! Build with:  gfortran -static-libgcc -o aoc_day04_p2 aoc_day04_p2.f90
...
program aoc_day04_p1
	...
	integer,parameter :: day = 4, part = 2
	...
	print *, ""
	write(*,'(A,I0)') "Last winning bingo card is: ",win_card
	write(*,'(A,I0)') "Final score for last bingo card is: ",win
	print *, ""
