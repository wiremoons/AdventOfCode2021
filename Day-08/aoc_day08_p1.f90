...
! Puzzle for Day 08 part 01 : 
! Build with:  gfortran -static-libgcc -o aoc_day08_p1 aoc_day08_p1.f90

program aoc_day08_p1
	...
	character(len=*), parameter :: filename = "day08-input.txt"
