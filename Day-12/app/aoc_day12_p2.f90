...
! Puzzle for Day 12 part 01 :
! Build (or run) with:
! gfortran -static-libgcc -o aoc_day12_p1 aoc_day12_p1.f90
! fpm run aoc_day12_p1

program aoc_day12_p1

    use, intrinsic :: iso_fortran_env, stderr => error_unit
    implicit none

    ! Declare and set constants the AOC day and part
    integer, parameter :: day = 12, part = 1

    ! Declare file related variables
    ! - Prod uses: day12-input.txt
    ! - Test uses: day12-TEST-input.txt
    character(len = *), parameter :: filename = "data/day12-input.txt"
