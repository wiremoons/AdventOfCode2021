...
! Puzzle for Day 02 part 01 : 
! Build with:  gfortran -static-libgcc -o aoc_day02_p1 aoc_day02_p1.f90

program aoc_day02_p1

	use, intrinsic :: iso_fortran_env
	implicit none

	! Declare and set constants the AOC day and part
	integer,parameter :: day = 2, part = 1
	...
	write(*,'(A,I8.8)') " » ANSWER: Final horizontal position multiplied by final depth: ",total_pos
